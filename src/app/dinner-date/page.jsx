...
const DinnerDatePage = () => {
  ...
  return (
    ...
    >
      <SwiperSlide><Image className='mx-auto justify-center items-center grid' src={first} width={400} height={400} alt="heroshot" /></SwiperSlide>
      <SwiperSlide><Image className='mx-auto justify-center items-center grid' src={second} width={400} height={400} alt="heroshot" /></SwiperSlide>
      <SwiperSlide><Image className='mx-auto justify-center items-center grid' src={third} width={400} height={400} alt="heroshot" /></SwiperSlide>
      <SwiperSlide><Image className='mx-auto justify-center items-center grid' src={fourth} width={400} height={400} alt="heroshot" /></SwiperSlide>
      <SwiperSlide><Image className='mx-auto justify-center items-center grid' src={fifth} width={400} height={400} alt="heroshot" /></SwiperSlide>
